...
<nav class="navbar navbar-expand navbar-dark bg-dark osahan-nav-top p-0">
    <div class="container">
        <a class="navbar-brand mr-2" href="index"><img src="../img/logo.png" alt="">
        </a>
        ...
        <ul class="navbar-nav ml-auto d-flex align-items-center">
            ...
            <#--               发帖-->
            <li class="nav-item">
                <a class="nav-link" href="/operate/tosubmit"><i class="feather-briefcase mr-2"></i><span class="d-none d-lg-inline">发帖</span></a>
            </li>
            <#--               我的帖子-->
            <li class="nav-item">
        ...
        <div class="row justify-content-center align-items-center d-flex vh-100">
            <div class="col-md-10 mx-auto">
                <div class="osahan-login py-4">
                    ...
                    <br><br>
                    <form action="/operate/submit" >
                        <div class="box shadow-sm border rounded bg-white mb-3 osahan-share-post">
                            <div class="row">
                                <div class="col-5">
                                    <label class="mb-1">账号</label>
                                    <input type="email" class="form-control" placeholder="昵称"/>
                                </div>
                            <div class="col-5">
                        ...
                        <div class="box shadow-sm border rounded bg-white mb-3 osahan-share-post">
                            ...
                            <div class="col-2">
                                ...
                                <select class="form-control" placeholder="教育">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="p-3 d-flex align-items-center w-100" href="#">
                                        ...
                                        <div class="w-100">
                                            <textarea placeholder="Write your thoughts..." class="form-control border-0 p-0 shadow-none" rows="8"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
