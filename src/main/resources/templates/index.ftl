      ...
      <div class="py-4">
         <div class="container">
            <div class="row">
               ...
               <aside class="col col-xl-3 order-xl-1 col-lg-6 order-lg-3 col-md-7 col-sm-6 col-12">
               ...
               <aside class="col col-xl-3 order-xl-3 col-lg-6 order-lg-2 col-md-5 col-sm-6 col-12">
